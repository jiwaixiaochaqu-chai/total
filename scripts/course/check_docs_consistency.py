...
REQUIRED_PATHS = (
    ...
    "docs/13-knowledge-governance.md",
    "docs/14-rag-quality.md",
    "docs/15-testing-system.md",
    "docs/16-observability-capacity.md",
    "docs/17-docker-delivery.md",
