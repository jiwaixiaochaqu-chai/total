...
使用方式：
    ...
    保留 Collection（供后续调试）：
    python scripts/demo/demo_ch04_milvus_basics.py --keep-collection

    或通过 Docker Compose：
    docker compose --env-file .env.compose run --rm api python scripts/demo/demo_ch04_milvus_basics.py
"""
