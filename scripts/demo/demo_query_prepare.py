...
#
# 用法示例：
#   python scripts\demo\demo_query_prepare.py "报销流程是什么"
#   python scripts\demo\demo_query_prepare.py "那审批呢" --history "报销流程是什么"
#   python scripts\demo\demo_query_prepare.py "报销流程" --source finance
#   python scripts\demo\demo_query_prepare.py "VPN 怎么连" --scenario equipment_ops
# ============================================================================
