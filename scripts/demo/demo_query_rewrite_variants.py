...
#
# 用法示例：
#   python scripts\demo\demo_query_rewrite_variants.py "那审批呢" --history "报销流程是什么"
#   python scripts\demo\demo_query_rewrite_variants.py "入职流程文档在哪里查看"
#   python scripts\demo\demo_query_rewrite_variants.py "报销流程" --source finance
# ============================================================================
