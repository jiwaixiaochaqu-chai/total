...
# 常用命令：
#   # 查看所有版本
#   python scripts/kb/manage_kb_versions.py list
#
#   # 创建新版本
#   python scripts/kb/manage_kb_versions.py create --description "2026-05-06 全量重建"
#
#   # 回滚到曾经发布过的历史版本（新版本发布请走 rebuild_kb_version.py）
#   python scripts/kb/manage_kb_versions.py activate kb_20260506_103000_xxxxxxxx
#
#   # 归档版本（不能归档当前 active）
#   python scripts/kb/manage_kb_versions.py archive kb_20260430_090000_xxxxxxxx
#
#   # 指定场景（默认为 ACTIVE_SCENARIO_ID）
#   python scripts/kb/manage_kb_versions.py --scenario equipment_ops list
#
# 为什么独立成脚本：
