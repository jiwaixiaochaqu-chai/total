...
#
# 用法示例：
#   python scripts\quality\check_performance_gate.py
#   python scripts\quality\check_performance_gate.py --report reports/performance/xxx.json
#   python scripts\quality\check_performance_gate.py --max-avg-total-ms 20000 --max-p95-total-ms 40000
# ============================================================================

"""根据性能基线报告判断首 token 和总耗时是否达标。
...
# ── 导入公共模块 ──
from scripts.quality.collect_performance_baseline import collect_baseline, default_output_path
...
class PerformanceGateThresholds:
    ...
    调用顺序：命令行入口 -> PerformanceGateThresholds。
    """
