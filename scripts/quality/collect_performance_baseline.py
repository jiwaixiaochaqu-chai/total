...
#
# 用法示例：
#   python scripts\quality\collect_performance_baseline.py
#   python scripts\quality\collect_performance_baseline.py --dataset eval_sets/multi_scenario_smoke.json --limit 20
#   python scripts\quality\collect_performance_baseline.py --no-warmup  # 冷启动也纳入统计
# ============================================================================

"""执行基准问题并采集 V1 查询链路性能数据。
...
def average_stage_timings(rows: list[dict[str, Any]]) -> dict[str, float]:
    ...
    调用顺序：命令行入口 -> average_stage_timings()。
    """
