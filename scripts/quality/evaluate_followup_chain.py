...
#
# 用法示例：
#   python scripts\quality\evaluate_followup_chain.py
#   python scripts\quality\evaluate_followup_chain.py --dataset eval_sets/multi_turn_followup_regression.json
#   python scripts\quality\evaluate_followup_chain.py --limit 20 --scenario enterprise_knowledge
# ============================================================================
...
def default_output_path(dataset: str) -> Path:
    ...
    name = resolve_eval_dataset_path(dataset).stem or "followup"
...
def evaluate_dataset(args: argparse.Namespace) -> dict[str, Any]:
    ...
    """
    dataset_path = resolve_eval_dataset_path(args.dataset)
    conversations = json.loads(dataset_path.read_text(encoding="utf-8"))[: args.limit]
